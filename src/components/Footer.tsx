            ...
            ">
                ...
                ">400 University Drive Suite 200 Coral <br />
                    ...
                    <div className=" md:h-[101px] mt-[40px]">
                        ...
                        <div className="flex flex-col items-start justify-center md:flex md:flex-row  md:items-center mt-[20px]  ">
                            ...
                            <Link href="/" className="text-[#000000] border-b-2 md:ml-[25px] py-[15px]  border-b-[#000000]  ">SUBSCRIBE</Link>
                        </div>
                    </div>
                </div>
